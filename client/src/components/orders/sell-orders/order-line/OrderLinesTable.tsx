        ...
        <Collapse in={openRow && rowToOpen === rowIndex} timeout="auto">
            <Box sx={{ paddingBottom: 2, paddingTop: 2}}>
                <Table size="small">
                    ...
                    <TableBody>
                        {/*{orderLines.map((line) => (*/}
                        {/*    <TableRow key={line.orderId + line.productVariation?.productId}>*/}
                        {/*        <TableCell>*/}
                        {/*            <Typography color="textSecondary" fontWeight="400">*/}
                        {/*                {line.productVariation?.productId}*/}
                        {/*            </Typography>*/}
                        {/*        </TableCell>*/}
                        {/*        <TableCell>*/}
                        {/*            <Typography color="textSecondary" fontWeight="400">*/}
                        {/*                {products.find(p => p.id === line.productVariation?.productId)?.name}*/}
                        {/*            </Typography>*/}
                        {/*        </TableCell>*/}
                        {/*        <TableCell>*/}
                        {/*            <Typography color="textSecondary" fontWeight="400">*/}
                        {/*                {productTypes.find(pt => pt.id === products.find(p => p.id === line.productVariation?.productId)?.productTypeId)?.name}*/}
                        {/*            </Typography>*/}
                        {/*        </TableCell>*/}
                        {/*        <TableCell>*/}
                        {/*            <Typography color="textSecondary" fontWeight="400">*/}
