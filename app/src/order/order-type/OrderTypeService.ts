...
export const getOrderTypes = (req: Request, res: Response) => {
    console.log("getProducts");
    res.json([{ id: 1, name: "Laptop" }, { id: 2, name: "Phone" }]);
};

export const getOrderTypeById = (req: Request, res: Response) => {
...
export const addOrderType = (req: Request, res: Response) => {
    console.log("addProduct");
    console.log("body: ", req.body);
    res.status(201).json({ message: `Product ${req.body.message} added successfully` });
};

export const updateOrderType = (req: Request, res: Response) => {
    const productId = Number(req.params.id);
...
export const deleteOrderType = (req: Request, res: Response) => {
    const productId = Number(req.params.id);
